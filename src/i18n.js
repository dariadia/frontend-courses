  ...
  en: {
    translation: {
      ...
      personalised: "Personalised mentouring course. Below you can check out the general outline of the course program. I adjust the plan individually depending on the goals and level of each student.",
       ...
       js_1: "Data types in JavaScript",
       js_1_details: "Primitive values (null, undefined, boolean, number...). Dynamic typing. Objects.",
       js_2: "Environment.",
       js_2_details: "Setting up a comfortable IDE, running JS code locally. Comments in the code.",
       js_3: "Functions, conditional statements, loops.",
       js_3_details: "How to write a function in JavaScript, how to use it. What operators exist 'out of the box', how conditions (if) work, what are loops.",
       js_4: "Methods of various data types.",
       js_4_details: "What out-of-the-box methods do strings, arrays, objects, numbers have? Where to use and how to use.",
       js_5: "Events and DOM API.",
       js_5_details: "What are events in JavaScript, DOM API. How to change html pages using JavaScript.",
       js_6: "Modules.",
       js_6_details: "What are modules, what are they for, and how to write them. What types of modules exist.",
       js_7: "BOM*",
       js_7_details: "DOM vs BOM* optional lesson for the curious.",
       js_8: "Testing and bugs.",
       js_8_details: "How to test JavaScript code. I have a bug, the code doesn’t work! – What should I do?",
       js_11: "Prototypes and inheritance.",
       js_11_details: "The mechanism by which objects inherit properties from each other: pitfalls.",
       js_10: "Arrow functions vs named functions.",
       js_10_details: "What are the differences, where it's better to use what.",
       js_9: "Fetch, async",
       js_9_details: "How fetch works, how you can get data through the API, configuration and requests, asynchronous functions.",
    }
  },
  ru: {
    translation: {
