...
const resources = {
  ...
  ru: {
    translation: {
      ...
      js_1: "Типы данных в JavaScript",
      js_1_details: "Примитивные значения (null, undefined, boolean, number...). Динамическая типизация. Объекты.",
      js_2: "Окружение.",
      js_2_details: "Настройка комфортного IDE, запуск JS кода локально. Комментарии в коде.",
      js_3: "Функции, операторы условия, циклы.",
      js_3_details: "Как написать функцию на JavaScript, как использовать. Какие существуют операторы 'из коробки', как работают условия (if), что такое циклы.",
      js_4: "Методы различных типов данных.",
      js_4_details: "Какие методы 'из коробки' есть у строк, массивов, объектов, чисел. Где применять и как пользоваться.",
      js_5: "События и DOM API.",
      js_5_details: "Что такое события в JavaScript, DOM API.Как изменять html страницы с помощью JavaScript.",
      js_6: "Модули.",
      js_6_details: "Что такое модули, для чего нужны и как писать. Какие существуют виды модулей.",
      js_7: "BOM*",
      js_7_details: "DOM vs BOM* опциональное занятие для любопытных.",
      js_8: "Тестирование и баги.",
      js_8_details: "Как тестировать код JavaScript. У меня баг, код не работает! – Что делать?",
      js_11: "Прототипы и наследование.",
      js_11_details: "Механизм, с помощью которого объекты наследуют свойства друг друга: ямы и подводные камни.",
      js_10: "Стрелочные функции vs именные.",
      js_10_details: "В чём отличия, где лучше использовать что.",
      js_9: "JavaScript (fetch, async)*",
      js_9_details: "Как работает fetch, как можно получать данные через API, настройка и запросов, асинхронные функции.",
    }
  }
};
