...
const resources = {
  ...
  ru: {
    translation: {
      ...
      react_base_1_details: "Определяем цели обучения, оценка текущего уровня знаний (*). Вводная лекция про React, что такое библиотека и чем она отличается от фреймворка.",
